...
public class MetaballView extends View {
    ...
    private void init() {
        ...
        // center[0]和center[1]分别是圆心坐标的X轴和Y轴坐标：(90, 39)
...
//        Log.e("onDraw", "onDraw");
        ...
        circle.center[0] = maxLength * mInterpolatedTime; // mInterpolatedTime = 0

        RectF ball1 = new RectF();
//        Log.e("onDraw", "center[0] = " + circle.center[0]);
//        Log.e("onDraw", "center[1] = " + circle.center[1]);
...
//        Log.e("onDraw", "ball1.centerX() = " + ball1.centerX());
//        Log.e("onDraw", "ball1.centerY() = " + ball1.centerY());
